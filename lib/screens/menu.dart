...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Jonathan Immanuel Tampubolon"; //nama
  final String npm = "2406395695"; //npm
  final String kelas = "F"; //kelas

  final List<ItemHomepage> items = [
    ItemHomepage("See Football Product", Icons.newspaper, Colors.blue),
...
class InfoCard extends StatelessWidget {
  // Kartu informasi yang menampilkan title dan description.
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.all(16.0),
        // Menyusun title dan description secara vertikal.
        child: Column(
          children: [
            Text(
              name,
